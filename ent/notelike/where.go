...
func ID(id int) predicate.NoteLike {
	return predicate.NoteLike(sql.FieldEQ(FieldID, id))
}
...
func IDNEQ(id int) predicate.NoteLike {
	return predicate.NoteLike(sql.FieldNEQ(FieldID, id))
}

// IDIn applies the In predicate on the ID field.
func IDIn(ids ...int) predicate.NoteLike {
	return predicate.NoteLike(sql.FieldIn(FieldID, ids...))
}

// IDNotIn applies the NotIn predicate on the ID field.
func IDNotIn(ids ...int) predicate.NoteLike {
	return predicate.NoteLike(sql.FieldNotIn(FieldID, ids...))
}

// IDGT applies the GT predicate on the ID field.
func IDGT(id int) predicate.NoteLike {
	return predicate.NoteLike(sql.FieldGT(FieldID, id))
}

// IDGTE applies the GTE predicate on the ID field.
func IDGTE(id int) predicate.NoteLike {
	return predicate.NoteLike(sql.FieldGTE(FieldID, id))
}

// IDLT applies the LT predicate on the ID field.
func IDLT(id int) predicate.NoteLike {
	return predicate.NoteLike(sql.FieldLT(FieldID, id))
}

// IDLTE applies the LTE predicate on the ID field.
func IDLTE(id int) predicate.NoteLike {
	return predicate.NoteLike(sql.FieldLTE(FieldID, id))
}

// CreatedAt applies equality check predicate on the "created_at" field. It's identical to CreatedAtEQ.
func CreatedAt(v time.Time) predicate.NoteLike {
	return predicate.NoteLike(sql.FieldEQ(FieldCreatedAt, v))
}
...
func CreatedAtNEQ(v time.Time) predicate.NoteLike {
	return predicate.NoteLike(sql.FieldNEQ(FieldCreatedAt, v))
}

// CreatedAtIn applies the In predicate on the "created_at" field.
func CreatedAtIn(vs ...time.Time) predicate.NoteLike {
	return predicate.NoteLike(sql.FieldIn(FieldCreatedAt, vs...))
}

// CreatedAtNotIn applies the NotIn predicate on the "created_at" field.
func CreatedAtNotIn(vs ...time.Time) predicate.NoteLike {
	return predicate.NoteLike(sql.FieldNotIn(FieldCreatedAt, vs...))
}

// CreatedAtGT applies the GT predicate on the "created_at" field.
func CreatedAtGT(v time.Time) predicate.NoteLike {
	return predicate.NoteLike(sql.FieldGT(FieldCreatedAt, v))
}

// CreatedAtGTE applies the GTE predicate on the "created_at" field.
func CreatedAtGTE(v time.Time) predicate.NoteLike {
	return predicate.NoteLike(sql.FieldGTE(FieldCreatedAt, v))
}

// CreatedAtLT applies the LT predicate on the "created_at" field.
func CreatedAtLT(v time.Time) predicate.NoteLike {
	return predicate.NoteLike(sql.FieldLT(FieldCreatedAt, v))
}

// CreatedAtLTE applies the LTE predicate on the "created_at" field.
func CreatedAtLTE(v time.Time) predicate.NoteLike {
	return predicate.NoteLike(sql.FieldLTE(FieldCreatedAt, v))
}

// HasUser applies the HasEdge predicate on the "user" edge.
func HasUser() predicate.NoteLike {
	return predicate.NoteLike(func(s *sql.Selector) {
...
func And(predicates ...predicate.NoteLike) predicate.NoteLike {
	return predicate.NoteLike(sql.AndPredicates(predicates...))
}

// Or groups predicates with the OR operator between them.
func Or(predicates ...predicate.NoteLike) predicate.NoteLike {
	return predicate.NoteLike(sql.OrPredicates(predicates...))
}

// Not applies the not operator on the given predicate.
func Not(p predicate.NoteLike) predicate.NoteLike {
	return predicate.NoteLike(sql.NotPredicates(p))
}
