...
func (uc *UserCreate) SetRegistrationMethod(um user.RegistrationMethod) *UserCreate {
	uc.mutation.SetRegistrationMethod(um)
	return uc
}
...
func (uc *UserCreate) SetEmailNotifications(b bool) *UserCreate {
	uc.mutation.SetEmailNotifications(b)
	return uc
}
...
func (uc *UserCreate) SetSmsNotifications(b bool) *UserCreate {
	uc.mutation.SetSmsNotifications(b)
	return uc
}
...
func (uc *UserCreate) AddNoteLikeIDs(ids ...int) *UserCreate {
	uc.mutation.AddNoteLikeIDs(ids...)
	return uc
}
...
func (uc *UserCreate) AddNoteRepostIDs(ids ...int) *UserCreate {
	uc.mutation.AddNoteRepostIDs(ids...)
	return uc
}
...
func (uc *UserCreate) AddNoteReposts(n ...*NoteRepost) *UserCreate {
	...
	return uc.AddNoteRepostIDs(ids...)
}
...
func (uc *UserCreate) defaults() {
	...
	if _, ok := uc.mutation.RegistrationMethod(); !ok {
		v := user.DefaultRegistrationMethod
		uc.mutation.SetRegistrationMethod(v)
	}
	if _, ok := uc.mutation.DarkMode(); !ok {
		v := user.DefaultDarkMode
		uc.mutation.SetDarkMode(v)
	}
	if _, ok := uc.mutation.EmailNotifications(); !ok {
		v := user.DefaultEmailNotifications
		uc.mutation.SetEmailNotifications(v)
	}
	if _, ok := uc.mutation.SmsNotifications(); !ok {
		v := user.DefaultSmsNotifications
		uc.mutation.SetSmsNotifications(v)
	}
...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.RegistrationMethod(); !ok {
		return &ValidationError{Name: "registration_method", err: errors.New(`ent: missing required field "User.registration_method"`)}
	}
	if v, ok := uc.mutation.RegistrationMethod(); ok {
	...
	if _, ok := uc.mutation.DarkMode(); !ok {
		return &ValidationError{Name: "dark_mode", err: errors.New(`ent: missing required field "User.dark_mode"`)}
	}
	...
	if _, ok := uc.mutation.EmailNotifications(); !ok {
		return &ValidationError{Name: "email_notifications", err: errors.New(`ent: missing required field "User.email_notifications"`)}
	}
	if _, ok := uc.mutation.SmsNotifications(); !ok {
		return &ValidationError{Name: "sms_notifications", err: errors.New(`ent: missing required field "User.sms_notifications"`)}
	}
	if _, ok := uc.mutation.IsActive(); !ok {
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.RegistrationMethod(); ok {
		_spec.SetField(user.FieldRegistrationMethod, field.TypeEnum, value)
		_node.RegistrationMethod = value
	}
	...
	if nodes := uc.mutation.NoteLikesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := uc.mutation.NoteRepostsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
